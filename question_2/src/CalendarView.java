...
public class CalendarView extends JPanel {
    ...
    private ArrayList<DayView> days = new ArrayList<>(DAYS_IN_ROW * DAYS_IN_COLUMN);
    ...
    public CalendarView(int year, int month) {
        ...
        for(int i = 0; i < DAYS_IN_ROW * DAYS_IN_COLUMN; i++) {
...
//        }
    ...
    public void paintComponent(Graphics g) {
        ...
        for(DayView dv : days) {
            dv.setDayView(new DayData(new ArrayList<>(), 5, 2020, 1, 1), false);
        }
    }
